...
def multi_p():
    mbt = MainconBackTester()
    # db = DowBacktester
    save_pa = makedir(f'./datas/backtest_res/myindex3')
    sy_li = mbt.symbol_li
...
def run_IndexBacktester(symbol='RB'):
    ...
    params = {'rate': 0.0002, 'atr_n': 21, 'win_n': 1, "index_ind": 3}
    db.run_symbol_backtesting(symbol, sp='myindex3', params=params, strategy=IndexStrategy)
